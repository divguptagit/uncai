      ...
      <main className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {error && (
              <div className="p-4 mb-4 text-sm border rounded-lg flex items-center space-x-2 bg-blue-100 border-blue-200 text-blue-700 dark:bg-blue-900/30 dark:border-blue-700/30 dark:text-blue-300">
