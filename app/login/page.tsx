      ...
      <main className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {error && (
              <div className="p-4 mb-4 text-sm border rounded-lg flex items-center space-x-2 bg-blue-50/50 border-blue-100 text-blue-800 dark:bg-blue-900/10 dark:border-blue-800/20 dark:text-blue-400">
